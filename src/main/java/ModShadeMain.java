...
public class ModShadeMain {
    ...
    public static void main(String[] args) throws Exception {
        ...
        res_writer = new PrintWriter(home_dir + "CEC2013-modShade/results.txt", "UTF-8");
        ...
        for (int funcNumber = 1; funcNumber < 29; funcNumber++){
            ...
            for (int k = 0; k < runs; k++) {
                ...
                writer = new PrintWriter(home_dir + "CEC2013-modShade/" + funcNumber + "-" + k + ".txt", "UTF-8");
            ...
            sol_writer = new PrintWriter(home_dir + "CEC2013-modShade/results_" + funcNumber + ".txt", "UTF-8");
