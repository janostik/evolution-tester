...
/**
 *
 * Db_SHADE algorithm with clustering management of population size.
 * 
 * @author wiki on 15/02/2018
 */
public class CmDb_SHADE extends Db_SHADE_analysis {

    public CmDb_SHADE(int D, int MAXFES, TestFunction f, int H, int NP, Random rndGenerator) {
