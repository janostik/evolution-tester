 ...
 *
 * @author adam on 15/6/2018
 */
public class liteSHADE2_analysis implements Algorithm {
     ...
     * @param rndGenerator 
     */
    public liteSHADE2_analysis(int D, int MAXFES, TestFunction f, int NP, util.random.Random rndGenerator) {
        this.D = D;
        this.MAXFES = MAXFES;
        this.f = f;
        this.NP = NP;
    ...
    public void writeMFhistory(String path) {
        ...
        try {
            ...
            Logger.getLogger(liteSHADE2_analysis.class.getName()).log(Level.SEVERE, null, ex);
...
//        }
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int k = 0; k < runs; k++) {
            ...
            for(Individual ind : ((liteSHADE2_analysis)shade).getBestHistory()){
                i++;
                if(ind.fitness < min){
                    min = ind.fitness;
                    best = i;
