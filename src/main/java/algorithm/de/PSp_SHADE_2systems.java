...
import model.probabilistic.RankedNormalGenerator2systems;
 ...
 */
public class PSp_SHADE_2systems extends P_SHADE {

    public PSp_SHADE_2systems(int D, int MAXFES, TestFunction f, int H, int NP, Random rndGenerator) {
        super(D, MAXFES, f, H, NP, rndGenerator);
        
        RankedNormalGenerator gens = new RankedNormalGenerator2systems();
    ...
    protected void updateRankings() {
        ...
        if(normalGenerator.get(chosenNormalGen).rank < 0.8){
