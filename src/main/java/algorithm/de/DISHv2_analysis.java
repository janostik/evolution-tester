...
/**
 *
 * DISH algorithm switching between mutation schemes.
 * current-to-pbest/1
 * rand/1
 * 
 * DISH mutation
 * F initialized to 0.6
 * CR initialized to 0.9
 * 
 * rand/1 mutation
 * F = 0.9
 * Cr = 1.0
 * 
 * @author adam on 28/03/2019
 */
public class DISHv2_analysis extends SHADE_analysis {

    protected final int minPopSize;
    protected final int maxPopSize;
    
    public DISHv2_analysis(int D, int MAXFES, TestFunction f, int H, int NP, Random rndGenerator, int minPopSize) {
    ...
    public Individual run() {
        ...
        /**
         * Added for mutation switching
         */
        int mutationSwitch = 0; //0 - current-to-pbest/1, 1 - rand/1
        Frand = 0.9;
        CRrand = 1.0;
        ...
        while (true) {
             ...
             */
                ...
                for(int i = 0; i < this.NP; i++) {
                     ...
                     * Mutation
                     */               
                    v = mutationRand1(parents, Frand);

                    /**
                     * Crossover
                     */
                    u = crossover(CRrand, v, x.vector);
             ...
             */
            mutationSwitch = (mutationSwitch + 1) % 2;
