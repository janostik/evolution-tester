 ...
 * jSO algorithm
 * 
 * @author adam on 20/11/2018
 */
public class UDb_jSO_analysis extends SHADE_analysis {

    protected final int minPopSize;
    protected final int maxPopSize;
    
    public UDb_jSO_analysis(int D, int MAXFES, TestFunction f, int H, int NP, Random rndGenerator, int minPopSize) {
    ...
    public Individual runAlgorithm() {
        ...
        double Fg, CRg, Fw, distO, distT;
        List<Individual> newPop, pBestArray;
        double[] v, pbest, pr1, pr2, u, center;
        int[] rIndexes;
        ...
        while (true) {
            ...
            wS = new ArrayList<>();
            center = this.getPopCenter(this.P);
            ...
            for (int i = 0; i < this.NP; i++) {
                ...
                if (trial.fitness < x.fitness) {
                    ...
                    this.S_CR.add(CRg);
                    this.Aext.add(x);
                    distO = euclid.getDistance(x.vector, center);
                    distT = euclid.getDistance(center, trial.vector);
                    wS.add(distT - distO);
...
//        System.out.println("100%");
     ...
     * @return 
     */
    protected List<Double> rescaleWs(List<Double> wS) {
     ...
     * @return 
     */
    protected double[] getPopCenter(List<Individual> population) {
        
        double[] center = new double[population.get(0).vector.length];
        double[] vector;
        ...
        for(int i = 0; i < center.length; i++) {
            center[i] = center[i]/population.size();
        }
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int k = 0; k < runs; k++) {
            ...
            shade = new UDb_jSO_analysis(dimension, MAXFES, tf, H, NP, generator, minNP);
