 ...
 */
public class PSp_SHADE_5systems extends P_SHADE {

    public PSp_SHADE_5systems(int D, int MAXFES, TestFunction f, int H, int NP, Random rndGenerator) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int k = 0; k < runs; k++) {
            ...
            shade = new PSp_SHADE_5systems(dimension, MAXFES, tf, H, NP, generator);
