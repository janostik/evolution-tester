 ...
 */
public class NwdCB_SHADE extends N_SHADE {

    Net new_net = new Net();
    double CRr;
    
    public NwdCB_SHADE(int D, int MAXFES, TestFunction f, int H, int NP, Random rndGenerator, int runNo, int funcNo, String path) {
