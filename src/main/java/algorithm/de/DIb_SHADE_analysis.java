...
/**
 *
 * SHADE algiorithm with Distance/Improvement weighted parameter adaptation
 * 
 * With added clustering analysis
 * 
 * @author wiki on 21/02/2018
 */
public class DIb_SHADE_analysis extends Db_SHADE_analysis {

    public int wDistance, wImprovement;
    
    public DIb_SHADE_analysis(int D, int MAXFES, TestFunction f, int H, int NP, Random rndGenerator, int wDistance, int wImprovement) {
