...
/**
 * 
 * DISH algorithm - multithreaded - crossover switch (binomial/shuffled exponential) and crossover with history
 * 
 * @author adam on 13/01/2020
 */
public class DISHsuperXover extends SHADE_analysis implements Runnable {
    ...
    public DISHsuperXover(int D, int MAXFES, TestFunction f, int H, int NP, Random rndGenerator, int minPopSize) {
...
//        TestFunction tf = new CuttingStock1D();
        ...
        for (int k = 0; k < runs; k++) {
            ...
            shade = new DISHsuperXover(dimension, MAXFES, tf, H, NP, generator, minNP);
