 ...
 * @author wiki
 */
public class seededLShaDE extends LShaDE {

    public seededLShaDE(int D, int MAXFES, TestFunction f, int H, int NP, Random rndGenerator, int minPopSize) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int k = 0; k < runs; k++) {
            ...
            shade = new seededLShaDE(dimension, MAXFES, tf, H, NP, generator, minNP);
