 ...
 */
public class CuttingStock1D_solver implements TestFunction {
    ...
    public CuttingStock1D_solver() {
    }

    public CuttingStock1D_solver(int[][] order, int[] stock, int cut_through) {
...
//                    System.out.println("Dim: " + i);
    ...
    public static void main(String[] args) {
        ...
        cut = new CuttingStock1D_solver(order, stock, cut_through);
