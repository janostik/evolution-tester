 ...
 */
public class Cec2015 implements TestFunction {
    ...
    public Cec2015(int nx, int func_num) throws Exception {
        ...
        if (ini_flag==0) /* initiailization*/
        {
            ...
            /*Load Matrix M*****************************************************/
            URL resource = Cec2015.class.getResource("/Cec2015/input_data/M_"+func_num+"_D" + nx + ".txt");
            ...
            if(cf_num>1){
                ...
                resource = Cec2015.class.getResource("/Cec2015/input_data/bias_"+func_num+".txt");
                fpt = Paths.get(resource.toURI()).toFile();//* Load bias data *
            ...
            resource = Cec2015.class.getResource("/Cec2015/input_data/shift_data_"+func_num+".txt");
            ...
            if(bShuffle[func_num]==1){
                ...
                resource = Cec2015.class.getResource("/Cec2015/input_data/shuffle_data_"+func_num+"_D"+nx+".txt");
                fpt = Paths.get(resource.toURI()).toFile();
                input = new Scanner(fpt);
                input.useLocale(Locale.US);
                if (!fpt.exists())
    ...
    public double fitness(double[] vector) {
        ...
        case 8:	
                ...
                break;
        case 9:	
                out=cf01(t,out,nx,OShift,M,bias,1);
                out+=900.0;
                break;
        case 10:	
                out=cf02(t,out,nx,OShift,M,SS,bias,1);
                out+=1000.0;
                break;
        case 11:	
                out=cf03(t,out,nx,OShift,M,bias,1);
                out+=1100.0;
                break;
        case 12:	
                out=cf04(t,out,nx,OShift,M,bias,1);
                out+=1200.0;
                break;
        case 13:	
                out=cf05(t,out,nx,OShift,M,SS,bias,1);
                out+=1300.0;
                break;
        case 14:	
                out=cf06(t,out,nx,OShift,M,bias,1);
                out+=1400.0;
                break;
        case 15:	
                out=cf07(t,out,nx,OShift,M,bias,1);
                out+=1500.0;
                break;
