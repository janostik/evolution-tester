 ...
 * 
 * 14 facilities - only 1 per region
 * 
 * @author wiki on 18/05/2016
 */
public class SpalovnyCR_14 extends Spalovny_regions {

    public SpalovnyCR_14() {
        ...
        super.facility_count = 14;
        super.number_of_cities = new int[]{1,17,21,7,15,10,22,13,15,15,26,16,15,13};
        ...
        try {
            ...
            Logger.getLogger(SpalovnyCR_14.class.getName()).log(Level.SEVERE, null, ex);
        }
	...
	try {
		...
		while ((line = br.readLine()) != null) {
            ...
            Logger.getLogger(SpalovnyCR_14.class.getName()).log(Level.SEVERE, null, e);
	} catch (IOException e) {
            Logger.getLogger(SpalovnyCR_14.class.getName()).log(Level.SEVERE, null, e);
	} finally {
		if (br != null) {
    ...
    public static void main(String[] args) {
        ...
        SpalovnyCR_14 sp = new SpalovnyCR_14();
        double[] vector = new double[206+2*14];
