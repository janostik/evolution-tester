...
/**
 *
 * @author adam on 14/01/2016
 */
public class Cec2014 implements TestFunction {
    ...
    public Cec2014(int nx, int func_num) throws Exception {
        ...
        if (ini_flag==0) /* initiailization*/
        {
            ...
            /*Load Matrix M*****************************************************/
            URL resource = Cec2014.class.getResource("/Cec2014/input_data/M_"+func_num+"_D" + nx + ".txt");
            ...
            if (func_num<23)
            {
                    resource = Cec2014.class.getResource("/Cec2014/input_data/shift_data_"+func_num+".txt");
            ...
            {
                    resource = Cec2014.class.getResource("/Cec2014/input_data/shuffle_data_"+func_num+"_D"+nx+".txt");
                    fpt = Paths.get(resource.toURI()).toFile();
                    input = new Scanner(fpt);
                    input.useLocale(Locale.US);
                    if (!fpt.exists())
    ...
    public double fitness(double[] vector) {
        ...
        {
            case 1:	
                    out=ellips_func(t,out,nx,OShift,M,1,1);
                    out+=100.0;
                    break;
            case 2:	
                    ...
                    break;
            case 3:	
                    out=discus_func(t,out,nx,OShift,M,1,1);
                    out+=300.0;
                    break;
            case 4:	
                    out=rosenbrock_func(t,out,nx,OShift,M,1,1);
                    out+=400.0;
                    break;
            case 5:
                    out=ackley_func(t,out,nx,OShift,M,1,1);
                    out+=500.0;
                    break;
            case 6:
                    out=weierstrass_func(t,out,nx,OShift,M,1,1);
                    out+=600.0;
                    break;
            case 7:	
                    ...
                    break;
            case 8:	
                    out=rastrigin_func(t,out,nx,OShift,M,1,0);
                    out+=800.0;
                    break;
            case 9:	
                    out=rastrigin_func(t,out,nx,OShift,M,1,1);
                    out+=900.0;
                    break;
            case 10:	
                    out=schwefel_func(t,out,nx,OShift,M,1,0);
                    out+=1000.0;
                    break;
            case 11:	
                    ...
                    break;
            case 12:	
                    out=katsuura_func(t,out,nx,OShift,M,1,1);
                    out+=1200.0;
                    break;
            case 13:	
                    out=happycat_func(t,out,nx,OShift,M,1,1);
                    out+=1300.0;
                    break;
            case 14:	
                    out=hgbat_func(t,out,nx,OShift,M,1,1);
                    out+=1400.0;
                    break;
            case 15:	
                    out=grie_rosen_func(t,out,nx,OShift,M,1,1);
                    out+=1500.0;
                    break;
            case 16:	
                    out=escaffer6_func(t,out,nx,OShift,M,1,1);
                    out+=1600.0;
                    break;
            case 17:	
                    ...
                    break;
            case 18:	
                    out=hf02(t,out,nx,OShift,M,SS,1,1);
                    out+=1800.0;
                    break;
            case 19:	
                    out=hf03(t,out,nx,OShift,M,SS,1,1);
                    out+=1900.0;
                    break;
            case 20:	
                    out=hf04(t,out,nx,OShift,M,SS,1,1);
                    out+=2000.0;
                    break;
            case 21:	
            ...
            case 28:
                    ...
                    break;
            case 29:
                    out=cf07(t,out,nx,OShift,M,SS,1);
                    out+=2900.0;
                    break;
            case 30:
                    out=cf08(t,out,nx,OShift,M,SS,1);
                    out+=3000.0;
                    break;
